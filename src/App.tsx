      ...
      sections: [
        {
          ...
          content: "A indicação da terapia canabinoide ocorre predominantemente após o <b>diagnóstico de refratariedade</b>, isto é, quando os tratamentos convencionais (remédios sintéticos, analgésicos ou anticonvulsivantes comuns) não surtiram o efeito desejado ou causaram efeitos colaterais severos. As principais condições incluem:",
          bullets: [
        ...
        },
        {
          ...
          content: "Apesar de o tratamento ser legalmente autorizado e prescrito por médicos registrados no CRM, os pacientes enfrentam frequentes <b>negativas de cobertura financeira</b>, seja pelas operadoras de planos de saúde, seja pelo Poder Público (SUS).\n\nA justificativa mais comum das operadoras é alegar que o medicamento não consta no Rol de Procedimentos da ANS ou que a importação via RDC 660 configuraria <b>\"tratamento experimental\"</b>. Esse argumento tem sido amplamente superado pelo Superior Tribunal de Justiça (STJ):",
          bullets: [
            ...
            { title: "Mitigação do Rol da ANS (Lei nº 14.454/2022)", text: "Com a nova legislação, o rol da ANS não é mais taxativo de forma absoluta. Havendo comprovação científica de eficácia e prescrição médica fundamentando a falha de alternativas convencionais, a cobertura <b>torna-se obrigatória.</b>" },
