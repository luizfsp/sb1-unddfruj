...
export default function App() {
  ...
  const analyzeCaseWithAI = async () => {
    ...
    try {
      ...
      setAiError(
        'Ocorreu um erro ao conectar com a IA. Por favor, tente novamente mais tarde.'
      );
    } finally {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
      ...
      <header
        className={`fixed w-full z-50 transition-all duration-300 ${
          isScrolled
            ...
            : 'bg-slate-900/95 backdrop-blur-sm py-5'
        }`}
      >
        <div className="container mx-auto px-4 md:px-8 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <Scale
              className={isScrolled ? 'text-blue-900' : 'text-amber-500'}
              size={32}
            />
            <div>
              <h1
          ...
          <nav className="hidden md:flex gap-8 items-center">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="bg-amber-500 hover:bg-amber-600 text-slate-900 px-6 py-2.5 rounded-full font-bold text-sm transition-transform hover:scale-105 shadow-lg"
            >
              Fale Conosco
            </a>
          </nav>
            ...
            <div className="md:w-3/5 text-center md:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-lg font-bold text-lg flex items-center justify-center gap-2 transition-all hover:shadow-[0_0_20px_rgba(5,150,105,0.4)] hover:-translate-y-1"
                >
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="flex flex-col items-center text-center px-4 pt-8 md:pt-0">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2 mt-2">
                Liminares de Urgência
              </h3>
              <p className="text-slate-600 font-medium text-sm px-4">
                Atuação ágil para garantir tratamentos e medicamentos vitais.
              </p>
            </div>
            <div className="flex flex-col items-center text-center px-4 pt-8 md:pt-0">
              ...
              <p className="text-slate-600 font-medium text-sm px-4">
                Soluções jurídicas sob medida para cada cliente.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">
              Atuamos contra as práticas abusivas de operadoras de saúde e do
              Estado, garantindo que o seu tratamento médico não seja
              interrompido ou negado.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-xl hover:border-blue-100 transition-all duration-300 group hover:-translate-y-2">
              ...
              <p className="text-slate-600 text-sm mb-6 leading-relaxed">
                Reversão de negativas para cirurgias, exames, próteses e
                contestação de reajustes abusivos (falsos coletivos ou faixa
                etária).
              </p>
              <a
                href={whatsappLink}
                className="text-blue-700 font-bold text-sm flex items-center gap-1 group-hover:text-amber-600 transition-colors"
              >
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-xl hover:border-blue-100 transition-all duration-300 group hover:-translate-y-2">
              ...
              <p className="text-slate-600 text-sm mb-6 leading-relaxed">
                Garantia de cobertura para terapias voltadas ao Transtorno do
                Espectro Autista (TEA), Home Care e doenças raras.
              </p>
              <a
                href={whatsappLink}
                className="text-blue-700 font-bold text-sm flex items-center gap-1 group-hover:text-amber-600 transition-colors"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-xl hover:border-blue-100 transition-all duration-300 group hover:-translate-y-2">
              ...
              <p className="text-slate-600 text-sm mb-6 leading-relaxed">
                Busca por responsabilidade civil e indenização por negligência,
                imprudência ou falha em prestação de serviços de saúde.
              </p>
              <a
                href={whatsappLink}
                className="text-blue-700 font-bold text-sm flex items-center gap-1 group-hover:text-amber-600 transition-colors"
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 mt-16 lg:mt-0">
              ...
              <div className="space-y-4 text-slate-600 text-lg leading-relaxed">
                <p>
                  Com mais de duas décadas de sólida experiência jurídica nos
                  mais diversos ramos corporativos e civis, o{' '}
                  <strong>Dr. Fabio Saraiva</strong> fundou o escritório com um
                  propósito claro: entregar um atendimento humanizado e
                  implacável na defesa dos pacientes.
                </p>
                <p>
                  No Direito da Saúde, sabemos que a vulnerabilidade e o rigor
                  técnico precisam andar juntos. Um processo contra uma gigante
                  operadora de saúde ou contra o Estado exige uma advocacia
                  artesanal, onde cada laudo e cada vírgula importam.
                </p>
                <p>
                  Nossa missão é ser o seu escudo jurídico. Protegemos famílias
                  contra os abusos do sistema, garantindo dignidade, tratamentos
                  e resultados rápidos no momento em que você mais precisa.
                </p>
              </div>
                ...
                <div className="flex items-center gap-4 bg-slate-50 p-6 rounded-xl border border-slate-100">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      O seu caso será conduzido diretamente pelos nossos
                      especialistas.
                    </p>
                  </div>
                </div>
      ...
      <section className="py-24 bg-blue-950 text-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-amber-500 font-bold tracking-widest uppercase text-sm mb-3">
          ...
          <div className="text-center mt-16">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex bg-white hover:bg-slate-100 text-blue-950 px-8 py-4 rounded-lg font-bold text-lg items-center justify-center gap-2 transition-all shadow-lg hover:-translate-y-1"
            >
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-4xl relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 text-lg">
              Descreva brevemente o seu problema (ex: negativa de cirurgia,
              falta de remédio). A nossa IA analisará o seu caso em segundos
              para direcionar e agilizar o atendimento com o especialista.
            </p>
          </div>
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-4 items-center justify-between bg-blue-50 p-4 rounded-xl border border-blue-100">
                  ...
                  <a
                    href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(
                      'Olá! Fiz a pré-análise do meu caso no site através da IA. Segue o resumo:\n\n'
      ...
      <section className="py-20 bg-emerald-700 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-emerald-100 text-xl mb-10 max-w-2xl mx-auto">
            A nossa equipe está pronta para analisar o seu caso agora mesmo, com
            total sigilo e foco na resolução rápida do seu problema.
          </p>
          <a
            href={whatsappLink}
            target="_blank"
            rel="noreferrer"
            className="inline-flex bg-amber-500 hover:bg-amber-400 text-slate-900 px-10 py-5 rounded-xl font-black text-xl items-center justify-center gap-3 transition-transform hover:scale-105 shadow-2xl"
          >
            <Phone size={28} />
      ...
      <footer className="bg-slate-950 pt-20 pb-10 text-slate-400 border-t-4 border-amber-500">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
            <div className="md:col-span-5">
              ...
              <p className="mb-6 max-w-md leading-relaxed">
                Experiência adquirida durante mais de 25 anos de atuação.
                Atendimento personalizado e exclusivo com dedicação, ética e
                transparência na defesa da sua saúde.
              </p>
            </div>

            <div className="md:col-span-3">
              <h5 className="text-white font-bold mb-6 uppercase tracking-wider text-sm">
                Links Rápidos
              </h5>
            ...
            <div className="md:col-span-4">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <span>
                    Av. Nove de Julho, n° 3229, 11° andar, CJ 1103
                    <br />
          ...
          <div className="border-t border-slate-800 pt-8 text-sm text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-4">
            <p>
              &copy; {new Date().getFullYear()} Saraiva & Advogados Associados.
  ...
  return (
    <div className="border border-slate-200 rounded-xl bg-white overflow-hidden transition-all duration-300">
      ...
      >
        ...
        <ChevronDown
          className={`text-blue-600 transition-transform duration-300 shrink-0 ${
            isOpen ? 'rotate-180' : ''
          }`}
          size={20}
        />
      ...
      >
        <p className="leading-relaxed border-t border-slate-100 pt-4">
          {answer}
        </p>
      </div>
    </div>
